...
public class ApiValidation
{
    ...
    public void PreciseResponseBodyAssertion(string requestUrl,
        string expectedJson,
        ...
        string? jsonBody = null)
    {
        ...
        {
            log.Error($"Response: <pre lang='json' style='max-height: 700px; overflow-y: scroll; max-width: 1070px;'><code>{response.Content}</code></pre><br/>" +
